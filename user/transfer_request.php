...
<head>
    ...
    <style>
        ...
        .status-card {background: white;border: 1px solid #e0e0e0; border-radius: 8px; padding: 25px;}
        ...
        .status-table th {text-align: left; padding: 15px; background: #fdfdfd;border-bottom: 2px solid #f28c28;color: #666; font-size: 0.8rem;}
        .status-table td {padding: 15px; border-bottom: 1px solid #eee;font-size: 0.9rem;}
        .status-text { font-weight: bold; }
        .approved { color: #2ecc71; }
        .pending { color: #f1c40f; }
        .refresh-btn {background: #f28c28; color: white;border: none;padding: 10px 30px;border-radius: 20px;float: right;margin-top: 20px;cursor: pointer;font-weight: bold;}

        .modal {display: none;position: fixed;z-index: 1;left: 0;top: 0;width: 100%;height: 100%;background-color: rgba(0,0,0,0.5);}
        .modal-content {background: #fff;margin: 10% auto;padding: 20px;width: 400px;border-radius: 10px; }
        .modal-content input,
        .modal-content select {width: 98%; padding: 8px; margin: 5px 0 10px;}

        .close {float: right;cursor: pointer;font-size: 20px;}
        .refresh-btn {background: #f28c28;color: white;border: none;padding: 10px 30px;border-radius: 20px;float: right;margin-top: 20px;cursor: pointer;font-weight: bold;}

        .transfer-container { padding: 20px; }
        .transfer-card {background: white;border: 1px solid #e0e0e0;border-radius: 8px;padding: 30px;max-width: 900px;margin: 0 auto;}
        .transfer-card h2 {text-align: center;margin-bottom: 30px;color: #333;font-size: 1.8rem;}
        ...
        .form-control {padding: 12px;border: 1px solid #ccc;border-radius: 6px;font-size: 1rem;}
        .submit-btn {grid-column: span 2;background-color: #f28c28;color: white;border: none;padding: 15px;border-radius: 30px;font-weight: bold;font-size: 1rem;cursor: pointer;margin-top: 20px;transition: background 0.3s;}
